...
_DARK_CHART_LAYOUT = dict(
    ...
    xaxis=dict(gridcolor="#333", zerolinecolor="#333", tickfont=dict(color="#ffffff", size=13)),
    yaxis=dict(gridcolor="#333", zerolinecolor="#333", tickfont=dict(color="#ffffff", size=13)),
